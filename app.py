...
st.title("🏔️ Trail Training Dashboard")
st.markdown("### Suivi d'entraînement pour objectifs 2026")
...
# Footer
st.divider()
st.caption("🏔️ Dashboard créé pour le suivi d'entraînement trail • Données synchronisées depuis Strava")
