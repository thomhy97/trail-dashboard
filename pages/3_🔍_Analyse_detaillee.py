...
def show_activity_detail_page(df, access_token):
    ...
    # Récupération de l'ID Strava si disponible
    # Note: Il faut que l'ID soit dans le DataFrame. 
    # Dans l'app principale, tu devras ajouter 'id' dans les colonnes à garder
